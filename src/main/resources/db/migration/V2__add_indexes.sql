...
CREATE INDEX IF NOT EXISTS idx_pokemon_id ON pokemon(idpokemon);
CREATE INDEX IF NOT EXISTS idx_type_id ON type(idtype);
CREATE INDEX IF NOT EXISTS idx_ability_id ON ability(idability);